...
This repo contains a collection of examples demonstrating how to use the RCR (ROS Central Registry) Bazel rules to generate interfaces and build ROS 2 nodes in multiple C++ and Python.
